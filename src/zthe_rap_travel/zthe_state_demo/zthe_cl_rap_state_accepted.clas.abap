CLASS zthe_cl_rap_state_accepted DEFINITION
  PUBLIC
  INHERITING FROM zthe_cl_rap_state_open
  CREATE PUBLIC .

  PUBLIC SECTION.
    METHODS: zthe_if_rap_state~accepttravel REDEFINITION.
  PROTECTED SECTION.
  PRIVATE SECTION.
ENDCLASS.
...
CLASS zthe_cl_rap_state_accepted IMPLEMENTATION.
  METHOD zthe_if_rap_state~accepttravel.
  "Deny the action and report
